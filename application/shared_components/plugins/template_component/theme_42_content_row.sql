...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(70031785278826154)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1997269550996897853)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1997268995984897852)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1740376932254624339)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70032641706826158)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70032978628826159)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70033294120826159)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70033561438826159)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70033825779826159)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70034141298826160)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70034443824826160)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(70033825779826159)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1997269550996897853)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70034779940826160)
,p_plugin_attribute_id=>wwv_flow_imp.id(70034443824826160)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70035178314826160)
,p_plugin_attribute_id=>wwv_flow_imp.id(70034443824826160)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70035509612826160)
,p_plugin_attribute_id=>wwv_flow_imp.id(70034443824826160)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70035948494826161)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(70034443824826160)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70036272190826161)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70036584004826161)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70036801857826161)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70037103768826161)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70037441331826161)
,p_plugin_attribute_id=>wwv_flow_imp.id(70037103768826161)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70037826915826162)
,p_plugin_attribute_id=>wwv_flow_imp.id(70037103768826161)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70038275687826162)
,p_plugin_attribute_id=>wwv_flow_imp.id(70037103768826161)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70038607687826162)
,p_plugin_attribute_id=>wwv_flow_imp.id(70037103768826161)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70039085649826162)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(70034141298826160)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1997268995984897852)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70039398595826162)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70039684372826163)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70039980379826163)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70040218339826163)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70040510806826163)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70040814763826163)
,p_plugin_attribute_id=>wwv_flow_imp.id(70040510806826163)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70041295623826163)
,p_plugin_attribute_id=>wwv_flow_imp.id(70040510806826163)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70041679945826164)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70041946923826164)
,p_plugin_attribute_id=>wwv_flow_imp.id(70041679945826164)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70042328138826164)
,p_plugin_attribute_id=>wwv_flow_imp.id(70041679945826164)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70042710795826164)
,p_plugin_attribute_id=>wwv_flow_imp.id(70041679945826164)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70043109587826164)
,p_plugin_attribute_id=>wwv_flow_imp.id(70041679945826164)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70043578965826164)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70043891696826165)
,p_plugin_attribute_id=>wwv_flow_imp.id(70043578965826164)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70044230419826165)
,p_plugin_attribute_id=>wwv_flow_imp.id(70043578965826164)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70044675421826165)
,p_plugin_attribute_id=>wwv_flow_imp.id(70043578965826164)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70045058387826165)
,p_plugin_attribute_id=>wwv_flow_imp.id(70043578965826164)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70045413171826165)
,p_plugin_attribute_id=>wwv_flow_imp.id(70043578965826164)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70045824311826166)
,p_plugin_attribute_id=>wwv_flow_imp.id(70043578965826164)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70046290265826166)
,p_plugin_attribute_id=>wwv_flow_imp.id(70043578965826164)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70046647965826166)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70046947785826166)
,p_plugin_attribute_id=>wwv_flow_imp.id(70046647965826166)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70047386582826166)
,p_plugin_attribute_id=>wwv_flow_imp.id(70046647965826166)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70047738597826166)
,p_plugin_attribute_id=>wwv_flow_imp.id(70046647965826166)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70048103104826167)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70048417382826167)
,p_plugin_attribute_id=>wwv_flow_imp.id(70048103104826167)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70048810150826167)
,p_plugin_attribute_id=>wwv_flow_imp.id(70048103104826167)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70049261750826167)
,p_plugin_attribute_id=>wwv_flow_imp.id(70048103104826167)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70049687517826167)
,p_plugin_attribute_id=>wwv_flow_imp.id(70048103104826167)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70050049093826168)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70050371966826168)
,p_plugin_attribute_id=>wwv_flow_imp.id(70050049093826168)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70050747647826168)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70051076217826168)
,p_plugin_attribute_id=>wwv_flow_imp.id(70050747647826168)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70051467936826168)
,p_plugin_attribute_id=>wwv_flow_imp.id(70050747647826168)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70051830430826168)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(1740376932254624339)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70052110880826169)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70052467306826169)
,p_plugin_attribute_id=>wwv_flow_imp.id(70052110880826169)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70052841711826169)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70053111072826169)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1878483441212719467)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1878484700732723615)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1581531926316961037)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1864889812538312734)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1865569113268395838)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1878481506145674481)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1878482839535688338)
,p_plugin_id=>wwv_flow_imp.id(70031785278826154)
