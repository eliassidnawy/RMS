...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(69999576649826127)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1870017343997709778)
,p_plugin_id=>wwv_flow_imp.id(69999576649826127)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1870017899009709779)
,p_plugin_id=>wwv_flow_imp.id(69999576649826127)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70000226945826131)
,p_plugin_id=>wwv_flow_imp.id(69999576649826127)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70000519806826131)
,p_plugin_id=>wwv_flow_imp.id(69999576649826127)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70000864151826131)
,p_plugin_id=>wwv_flow_imp.id(69999576649826127)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70001135481826131)
,p_plugin_id=>wwv_flow_imp.id(69999576649826127)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70001458100826131)
,p_plugin_id=>wwv_flow_imp.id(69999576649826127)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(70000864151826131)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1870017899009709779)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70001773818826132)
,p_plugin_attribute_id=>wwv_flow_imp.id(70001458100826131)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70002109711826132)
,p_plugin_attribute_id=>wwv_flow_imp.id(70001458100826131)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70002562176826132)
,p_plugin_attribute_id=>wwv_flow_imp.id(70001458100826131)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70002980384826132)
,p_plugin_id=>wwv_flow_imp.id(69999576649826127)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(70001458100826131)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70003247848826132)
,p_plugin_id=>wwv_flow_imp.id(69999576649826127)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70003528607826133)
,p_plugin_id=>wwv_flow_imp.id(69999576649826127)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70003852116826133)
,p_plugin_id=>wwv_flow_imp.id(69999576649826127)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70004107912826133)
,p_plugin_id=>wwv_flow_imp.id(69999576649826127)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70004449584826133)
,p_plugin_attribute_id=>wwv_flow_imp.id(70004107912826133)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70004865769826133)
,p_plugin_attribute_id=>wwv_flow_imp.id(70004107912826133)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70005286679826134)
,p_plugin_attribute_id=>wwv_flow_imp.id(70004107912826133)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70005670203826134)
,p_plugin_attribute_id=>wwv_flow_imp.id(70004107912826133)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70006035390826134)
,p_plugin_id=>wwv_flow_imp.id(69999576649826127)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(70001135481826131)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1870017343997709778)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70006385323826134)
,p_plugin_id=>wwv_flow_imp.id(69999576649826127)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70006645743826134)
,p_plugin_id=>wwv_flow_imp.id(69999576649826127)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70006977062826134)
,p_plugin_id=>wwv_flow_imp.id(69999576649826127)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70007299495826134)
,p_plugin_id=>wwv_flow_imp.id(69999576649826127)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70007572585826135)
,p_plugin_id=>wwv_flow_imp.id(69999576649826127)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70007879272826135)
,p_plugin_attribute_id=>wwv_flow_imp.id(70007572585826135)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70008217107826135)
,p_plugin_attribute_id=>wwv_flow_imp.id(70007572585826135)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70008683888826135)
,p_plugin_id=>wwv_flow_imp.id(69999576649826127)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70008999594826135)
,p_plugin_attribute_id=>wwv_flow_imp.id(70008683888826135)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70009327776826135)
,p_plugin_attribute_id=>wwv_flow_imp.id(70008683888826135)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70009714451826136)
,p_plugin_attribute_id=>wwv_flow_imp.id(70008683888826135)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70010118385826136)
,p_plugin_id=>wwv_flow_imp.id(69999576649826127)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70010415979826136)
,p_plugin_attribute_id=>wwv_flow_imp.id(70010118385826136)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70010864937826136)
,p_plugin_attribute_id=>wwv_flow_imp.id(70010118385826136)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70011231803826137)
,p_plugin_attribute_id=>wwv_flow_imp.id(70010118385826136)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70011679194826137)
,p_plugin_attribute_id=>wwv_flow_imp.id(70010118385826136)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70012049139826137)
,p_plugin_attribute_id=>wwv_flow_imp.id(70010118385826136)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70012491630826137)
,p_plugin_id=>wwv_flow_imp.id(69999576649826127)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70012716822826137)
,p_plugin_attribute_id=>wwv_flow_imp.id(70012491630826137)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70013188870826137)
,p_plugin_id=>wwv_flow_imp.id(69999576649826127)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1870220951166856407)
,p_plugin_id=>wwv_flow_imp.id(69999576649826127)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
