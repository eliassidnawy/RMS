...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_imp.id(69820932209826003)
,p_default_dialog_template=>wwv_flow_imp.id(69800555611825998)
,p_error_template=>wwv_flow_imp.id(69802011193825998)
,p_printer_friendly_template=>wwv_flow_imp.id(69820932209826003)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_imp.id(69802011193825998)
...
,p_default_report_template=>wwv_flow_imp.id(69931704442826041)
