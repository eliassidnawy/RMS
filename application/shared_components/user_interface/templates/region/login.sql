...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(69890946854826027)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69891243259826028)
,p_plug_template_id=>wwv_flow_imp.id(69890946854826027)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69891500582826028)
,p_plug_template_id=>wwv_flow_imp.id(69890946854826027)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69891828880826028)
,p_plug_template_id=>wwv_flow_imp.id(69890946854826027)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69892199015826028)
,p_plug_template_id=>wwv_flow_imp.id(69890946854826027)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69892469605826028)
,p_plug_template_id=>wwv_flow_imp.id(69890946854826027)
,p_name=>'Sub Regions'
