...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(69862853521826020)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69863133323826020)
,p_plug_template_id=>wwv_flow_imp.id(69862853521826020)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69863474222826020)
,p_plug_template_id=>wwv_flow_imp.id(69862853521826020)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69863781983826020)
,p_plug_template_id=>wwv_flow_imp.id(69862853521826020)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69864092928826020)
,p_plug_template_id=>wwv_flow_imp.id(69862853521826020)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69864321373826020)
,p_plug_template_id=>wwv_flow_imp.id(69862853521826020)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
