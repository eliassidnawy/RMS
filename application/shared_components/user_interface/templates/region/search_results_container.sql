...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(69893409029826028)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69893791550826028)
,p_plug_template_id=>wwv_flow_imp.id(69893409029826028)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69894076939826028)
,p_plug_template_id=>wwv_flow_imp.id(69893409029826028)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69894398025826028)
,p_plug_template_id=>wwv_flow_imp.id(69893409029826028)
,p_name=>'Sub Regions'
