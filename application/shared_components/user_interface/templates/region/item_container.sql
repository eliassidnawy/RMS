...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(69888479511826027)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69888702479826027)
,p_plug_template_id=>wwv_flow_imp.id(69888479511826027)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69889027161826027)
,p_plug_template_id=>wwv_flow_imp.id(69888479511826027)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69889391562826027)
,p_plug_template_id=>wwv_flow_imp.id(69888479511826027)
,p_name=>'Button Start'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(72743531758855127)
,p_plug_template_id=>wwv_flow_imp.id(69888479511826027)
,p_name=>'Sub Regions'
