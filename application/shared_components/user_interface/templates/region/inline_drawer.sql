...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(69876382306826024)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69876643411826024)
,p_plug_template_id=>wwv_flow_imp.id(69876382306826024)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69876914233826024)
,p_plug_template_id=>wwv_flow_imp.id(69876382306826024)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69877237794826024)
,p_plug_template_id=>wwv_flow_imp.id(69876382306826024)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69877512543826024)
,p_plug_template_id=>wwv_flow_imp.id(69876382306826024)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69877864214826024)
,p_plug_template_id=>wwv_flow_imp.id(69876382306826024)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69878104032826024)
,p_plug_template_id=>wwv_flow_imp.id(69876382306826024)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69878463525826024)
,p_plug_template_id=>wwv_flow_imp.id(69876382306826024)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69878778020826024)
,p_plug_template_id=>wwv_flow_imp.id(69876382306826024)
,p_name=>'Sub Regions'
