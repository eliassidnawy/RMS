prompt --application/shared_components/user_interface/templates/page/standardactstikcyfooter
begin
--   Manifest
--     TEMPLATE: STANDARDACTSTIKCYFOOTER
--   Manifest End
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(82881483905831886)
,p_theme_id=>42
,p_name=>'Standard-ACT-stikcy-Footer'
,p_internal_name=>'STANDARDACTSTIKCYFOOTER'
,p_is_popup=>false
,p_javascript_code_onload=>'apex.theme42.initializePage.noSideCol();'
,p_css_file_urls=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#APP_FILES#AppStyle.css',
'#APP_FILES#button-custom.css',
'#APP_FILES#DialogModal.css'))
...
'        <div class="t-Body-fullContent">#REGION_POSITION_05#</div>',
'      </main>',
'      <footer class="t-Footer" id="t_Footer" role="contentinfo">',
'        <div class="t-Footer-body">',
'          <div class="t-Footer-content">#REGION_POSITION_08#</div>',
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82881951111831886)
,p_page_template_id=>wwv_flow_imp.id(82881483905831886)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82882452675831886)
,p_page_template_id=>wwv_flow_imp.id(82881483905831886)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82882957314831886)
,p_page_template_id=>wwv_flow_imp.id(82881483905831886)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82883425583831887)
,p_page_template_id=>wwv_flow_imp.id(82881483905831886)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82883919917831887)
,p_page_template_id=>wwv_flow_imp.id(82881483905831886)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82884414619831887)
,p_page_template_id=>wwv_flow_imp.id(82881483905831886)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82884991669831887)
,p_page_template_id=>wwv_flow_imp.id(82881483905831886)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82885446768831887)
,p_page_template_id=>wwv_flow_imp.id(82881483905831886)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82885993820831887)
,p_page_template_id=>wwv_flow_imp.id(82881483905831886)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82886457899831887)
,p_page_template_id=>wwv_flow_imp.id(82881483905831886)
