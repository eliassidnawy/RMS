prompt --application/shared_components/user_interface/templates/page/standardaddcssfile
begin
--   Manifest
--     TEMPLATE: STANDARDADDCSSFILE
--   Manifest End
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(82875688123831883)
,p_theme_id=>42
,p_name=>'Standard-ACT'
,p_internal_name=>'STANDARDADDCSSFILE'
,p_is_popup=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82876103196831884)
,p_page_template_id=>wwv_flow_imp.id(82875688123831883)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82876669759831884)
,p_page_template_id=>wwv_flow_imp.id(82875688123831883)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82877194918831884)
,p_page_template_id=>wwv_flow_imp.id(82875688123831883)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82877672974831885)
,p_page_template_id=>wwv_flow_imp.id(82875688123831883)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82878161103831885)
,p_page_template_id=>wwv_flow_imp.id(82875688123831883)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82878660708831885)
,p_page_template_id=>wwv_flow_imp.id(82875688123831883)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82879105420831885)
,p_page_template_id=>wwv_flow_imp.id(82875688123831883)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82879669289831885)
,p_page_template_id=>wwv_flow_imp.id(82875688123831883)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82880102642831885)
,p_page_template_id=>wwv_flow_imp.id(82875688123831883)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82880617792831885)
,p_page_template_id=>wwv_flow_imp.id(82875688123831883)
