prompt --application/shared_components/user_interface/templates/report/standardact
begin
--   Manifest
--     ROW TEMPLATE: STANDARDACT
--   Manifest End
...
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(82912724906016754)
,p_row_template_name=>'standard-ACT'
,p_internal_name=>'STANDARDACT'
,p_css_file_urls=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#APP_FILES#interactive-report.css',
'#APP_FILES#breadcrumb-style.css'))
