...
@@application/shared_components/files/quarterdata_json.sql
@@application/shared_components/files/plugin_dashboard_css.sql
@@application/shared_components/files/plugin_dashboard_items_css.sql
@@application/shared_components/files/plugin_dashboard_items_min_css.sql
@@application/shared_components/files/appstyle_css.sql
@@application/shared_components/files/icons_acteos_logo_512_png.sql
@@application/shared_components/files/icons_warning_popup_01_jpg.sql
@@application/shared_components/files/breadcrumb_style_css.sql
@@application/shared_components/files/breadcrumb_style_min_css.sql
@@application/shared_components/files/button_custom_css.sql
@@application/shared_components/files/button_custom_min_css.sql
@@application/shared_components/files/dialogmodal_css.sql
@@application/shared_components/files/dialogmodal_min_css.sql
@@application/shared_components/files/formstyle_css.sql
@@application/shared_components/files/formstyle_min_css.sql
...
@@application/shared_components/files/login_css.sql
@@application/shared_components/files/login_min_css.sql
@@application/shared_components/files/navigationmenu_css.sql
@@application/shared_components/files/sfprodisplaybold_webfont_woff.sql
@@application/shared_components/files/sfprodisplaybold_webfont_woff2.sql
@@application/shared_components/files/sfprodisplaymedium_webfont_woff.sql
@@application/shared_components/files/sfprodisplaymedium_webfont_woff2.sql
@@application/shared_components/files/sfprodisplayregular_webfont_woff.sql
@@application/shared_components/files/sfprodisplayregular_webfont_woff2.sql
@@application/shared_components/files/tabcontainer_css.sql
@@application/shared_components/files/tabcontainer_min_css.sql
@@application/shared_components/files/appstyle_min_css.sql
@@application/shared_components/files/plugin_dashboard_min_css.sql
@@application/shared_components/files/navigationmenu_min_css.sql
@@application/plugin_settings.sql
@@application/shared_components/security/authorizations/administration_rights.sql
@@application/shared_components/navigation/navigation_bar.sql
@@application/shared_components/logic/application_items/g9000_affichage_unite.sql
@@application/shared_components/logic/application_items/g_act_anterieures.sql
@@application/shared_components/logic/application_items/g_now_date.sql
@@application/shared_components/logic/application_items/g_site.sql
...
@@application/shared_components/user_interface/templates/page/modal_dialog_act.sql
@@application/shared_components/user_interface/templates/page/standardaddcssfile.sql
@@application/shared_components/user_interface/templates/page/standardactstikcyfooter.sql
@@application/shared_components/user_interface/templates/page/loginact.sql
...
@@application/shared_components/user_interface/templates/region/interactivereportact.sql
@@application/shared_components/user_interface/templates/region/interactivereportact2.sql
@@application/shared_components/user_interface/templates/region/tabscontaineract.sql
...
@@application/shared_components/user_interface/templates/report/standardact.sql
...
@@application/shared_components/user_interface/templates/breadcrumb/breadcrumbact.sql
...
@@application/shared_components/plugins/region_type/apex_bi_dashboard_d3.sql
