...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(70016352794826142)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2217099351455933095)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2217099906467933096)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70017071589826144)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70017319323826145)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70017600515826145)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70017909172826145)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70018248748826145)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70018541277826145)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70018868863826146)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(70018248748826145)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2217099906467933096)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70019116490826146)
,p_plugin_attribute_id=>wwv_flow_imp.id(70018868863826146)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70019513784826146)
,p_plugin_attribute_id=>wwv_flow_imp.id(70018868863826146)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70019935100826146)
,p_plugin_attribute_id=>wwv_flow_imp.id(70018868863826146)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70020316571826147)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(70018868863826146)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70020687373826147)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70020967369826147)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70021223805826147)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70021547547826147)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70021870424826147)
,p_plugin_attribute_id=>wwv_flow_imp.id(70021547547826147)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70022206185826148)
,p_plugin_attribute_id=>wwv_flow_imp.id(70021547547826147)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70022672173826148)
,p_plugin_attribute_id=>wwv_flow_imp.id(70021547547826147)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70023090260826148)
,p_plugin_attribute_id=>wwv_flow_imp.id(70021547547826147)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70023412028826148)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(70018541277826145)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2217099351455933095)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70023718516826148)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70024060517826148)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70024387616826149)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70024667220826149)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70024942528826149)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70025277002826149)
,p_plugin_attribute_id=>wwv_flow_imp.id(70024942528826149)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70025671005826149)
,p_plugin_attribute_id=>wwv_flow_imp.id(70024942528826149)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70026055738826149)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70026330265826149)
,p_plugin_attribute_id=>wwv_flow_imp.id(70026055738826149)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70026726691826150)
,p_plugin_attribute_id=>wwv_flow_imp.id(70026055738826149)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70027175397826150)
,p_plugin_attribute_id=>wwv_flow_imp.id(70026055738826149)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70027564001826150)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(70027857852826150)
,p_plugin_attribute_id=>wwv_flow_imp.id(70027564001826150)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-Timeline--compact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(70028285496826150)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1864869251654141682)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1979280614642405283)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2098311861616709724)
,p_plugin_id=>wwv_flow_imp.id(70016352794826142)
,p_name=>'Avatar Link'
