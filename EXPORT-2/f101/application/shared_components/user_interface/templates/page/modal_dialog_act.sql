prompt --application/shared_components/user_interface/templates/page/modal_dialog_act
begin
--   Manifest
--     TEMPLATE: MODAL_DIALOG_ACT
--   Manifest End
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(82872830288831880)
,p_theme_id=>42
,p_name=>'Modal Dialog ACT'
,p_internal_name=>'MODAL_DIALOG_ACT'
,p_is_popup=>true
,p_javascript_code_onload=>'apex.theme42.initializePage.modalDialog();'
,p_css_file_urls=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#APP_FILES#button-custom#MIN#.css',
'#APP_FILES#formStyle#MIN#.css',
'#APP_FILES#AppStyle#MIN#.css',
'#APP_FILES#TabContainer#MIN#.css',
'#APP_FILES#DialogModal#MIN#.css',
''))
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82873206872831882)
,p_page_template_id=>wwv_flow_imp.id(82872830288831880)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82873712387831882)
,p_page_template_id=>wwv_flow_imp.id(82872830288831880)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82874203884831883)
,p_page_template_id=>wwv_flow_imp.id(82872830288831880)
