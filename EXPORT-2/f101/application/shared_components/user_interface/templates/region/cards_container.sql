...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(69836676308826012)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69836965834826012)
,p_plug_template_id=>wwv_flow_imp.id(69836676308826012)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69837219759826012)
,p_plug_template_id=>wwv_flow_imp.id(69836676308826012)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(69837551892826012)
,p_plug_template_id=>wwv_flow_imp.id(69836676308826012)
,p_name=>'Sub Regions'
