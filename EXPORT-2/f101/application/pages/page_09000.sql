...
'width: fit-content;',
'}',
'.dashboard-toggle-tab.t-Form-fieldContainer--radioButtonGroup .apex-item-grid .apex-item-grid-row {display: flex;}',
'',
...
'',
'/*gestion resource*/',
'.row-indicator-label{background-color: var(--u-color-13-contrast); border-radius: .5rem; margin-bottom: 1rem;}',
'.component-indicator-label .t-Form-inputContainer .t-Form-itemWrapper , .component-indicator-label .t-Form-labelContainer { min-height: 2rem;}',
...
'.component-badge-resource .t-Badge .t-Badge-icon {font-size: 2.5rem !important; order: 1;}',
'.component-badge-resource .t-Badge-value{ font-size: 2.5rem; line-height: normal; color: var(--ats-color-black-600); order: 2;}',
'.component-badge-resource .t-Badge-label{ color: var(--ats-color-black-400); order: 3; flex: 1 1 160px;}'))
,p_step_template=>wwv_flow_imp.id(69817511991826002)
,p_page_template_options=>'#DEFAULT#'
,p_page_component_map=>'27'
,p_last_updated_by=>'N.JUREIDINI'
,p_last_upd_yyyymmddhh24miss=>'20250508111957'
);
...
'                )',
'            END',
'        WHEN :P9000_COLIS = ''L'' THEN -- LISTES',
'            CASE',
'                WHEN :G_ACT_ANTERIEURES = ''N'' THEN (',
'                    SELECT COALESCE(max(VALUE),0) ',
'                      FROM ORDER_PLANNING_DAY',
...
,p_parent_plug_id=>wwv_flow_imp.id(73431527314648919)
,p_region_sub_css_classes=>'component-badge-resource'
,p_region_template_options=>'#DEFAULT#:t-Form--noPadding:t-Form--xlarge:t-Form--stretchInputs:t-Form--leftLabels:margin-top-lg'
,p_plug_template=>wwv_flow_imp.id(69830917595826011)
,p_plug_display_sequence=>50
,p_plug_grid_column_span=>4
,p_query_type=>'SQL'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(84926599981729102)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(73431366183648917)
,p_button_name=>'New'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(69969320835826062)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(84604586990671011)
,p_name=>'REFRESH_BADGES'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(84604635995671012)
,p_event_id=>wwv_flow_imp.id(84604586990671011)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(84926645518729103)
,p_name=>'New_1'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(84926599981729102)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(84926730184729104)
,p_event_id=>wwv_flow_imp.id(84926645518729103)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    apex.server.process("GET_GAUGE_VALUE", {}, {',
'        dataType: "text",',
'        success: function(data) {',
'            apex.region("gauge-segmented").refresh();',
'        },',
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(84926815545729105)
,p_process_sequence=>10
,p_process_point=>'ON_DEMAND'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'GET_GAUGE_VALUE'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT NUMBER_LISTS',
'  INTO :P9000_GAUGE_VALUE',
'  FROM PROGRESS_OVERVIEW',
' WHERE TOUR_STATUS_CODE = ''L'';'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>84926815545729105
);
wwv_flow_imp.component_end;
end;
/
